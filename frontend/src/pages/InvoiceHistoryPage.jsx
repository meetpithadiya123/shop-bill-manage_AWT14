    ...
    <div className="mx-auto max-w-7xl animate-in fade-in slide-in-from-bottom-4 duration-700 p-6 md:p-12 min-h-screen pb-24">
      <div className="mb-10 flex flex-col justify-between gap-4 md:flex-row md:items-end">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="flex h-fit items-center gap-2 rounded-2xl bg-indigo-600 px-4 py-2 shadow-lg shadow-indigo-100 text-white">
            <span className="text-[10px] font-black uppercase tracking-widest opacity-80">Total Revenue:</span>
            <span className="text-sm font-black">
              Rs. {invoices.reduce((sum, inv) => sum + (Number(inv.total) || 0), 0).toLocaleString('en-IN', { minimumFractionDigits: 2 })}
            </span>
          </div>
        </div>
      </div>
